...
import (
	...
	"github.com/MadAppGang/stripe-go/account"
	"github.com/MadAppGang/stripe-go/balance"
	"github.com/MadAppGang/stripe-go/bankaccount"
	"github.com/MadAppGang/stripe-go/bitcoinreceiver"
	"github.com/MadAppGang/stripe-go/bitcointransaction"
	"github.com/MadAppGang/stripe-go/card"
	"github.com/MadAppGang/stripe-go/charge"
	"github.com/MadAppGang/stripe-go/countryspec"
	"github.com/MadAppGang/stripe-go/coupon"
	"github.com/MadAppGang/stripe-go/customer"
	"github.com/MadAppGang/stripe-go/discount"
	"github.com/MadAppGang/stripe-go/dispute"
	"github.com/MadAppGang/stripe-go/ephemeralkey"
	"github.com/MadAppGang/stripe-go/event"
	"github.com/MadAppGang/stripe-go/exchangerate"
	"github.com/MadAppGang/stripe-go/fee"
	"github.com/MadAppGang/stripe-go/feerefund"
	"github.com/MadAppGang/stripe-go/fileupload"
	"github.com/MadAppGang/stripe-go/invoice"
	"github.com/MadAppGang/stripe-go/invoiceitem"
	"github.com/MadAppGang/stripe-go/loginlink"
	"github.com/MadAppGang/stripe-go/order"
	"github.com/MadAppGang/stripe-go/orderreturn"
	"github.com/MadAppGang/stripe-go/paymentsource"
	"github.com/MadAppGang/stripe-go/payout"
	"github.com/MadAppGang/stripe-go/plan"
	"github.com/MadAppGang/stripe-go/product"
	"github.com/MadAppGang/stripe-go/recipient"
	"github.com/MadAppGang/stripe-go/refund"
	"github.com/MadAppGang/stripe-go/reversal"
	"github.com/MadAppGang/stripe-go/sku"
	"github.com/MadAppGang/stripe-go/source"
	"github.com/MadAppGang/stripe-go/sub"
	"github.com/MadAppGang/stripe-go/subitem"
	"github.com/MadAppGang/stripe-go/token"
	"github.com/MadAppGang/stripe-go/transfer"
)
